/*
 * Game Core - Demo 4 (Asynchronous model loading)
 *
 * An example that implements asynchronous JSON model loading (same as game.core.demo1.js but _game.level.create() and _game.player.create() have changed)
 */
